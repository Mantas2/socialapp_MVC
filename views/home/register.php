...
<body>
    ...
    <div class="flex flex-col items-center justify-center h-screen">
        <div class="w-full max-w-md">
            <form class="bg-gray-200 shadow-md rounded px-8 pt-6 pb-8 mb-4" action="/register" method="post">
                ...
                <div class="mb-4">
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            id="username" type="username" name="username" placeholder="Enter your username">
                    </div>
                    <div class="mb-6">
